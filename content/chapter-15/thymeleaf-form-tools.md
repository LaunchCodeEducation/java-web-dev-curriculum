...
1.  A no-arg constructor has been created. It simply sets the `id` of
...
One additional result of using `th:field` is that if the `Event` object
...
<figure>
<img src="figures/display-validation-errors.png" width="700"
