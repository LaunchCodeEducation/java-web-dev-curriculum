...
This will look almost precisely like what you have done for employer data above. Refer back to [that section](http://education.launchcode.org/java-web-dev-curriculum/assignments/techjobs-persistent/part-three/#updating-homecontroller) to inject the controller with skill data.
