...
1. Use the _Generate_ option again to add the `equals` and `hashCode` methods. Refer to the [Classes and Objects Part 2]("../../../../classes-part-2/reading/intellij-shortcut/index.md") IntelliJ Generator Shortcut section if you need a quick review.
...
[Next]("../../../assignments/techjobs-oo/task3/index.md")
